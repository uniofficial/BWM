...
public class ItemImageController {
     ...
     * @param images              업로드할 이미지 파일들. multipart/form-data로 같은
     *                            필드명("images")에 여러 개 담아서 보냄
    ...
    public ResponseEntity<List<ItemImageResponse>> uploadImages(
            ...
            @RequestParam(value = "representativeIndex", required = false, defaultValue = "0") Integer representativeIndex) {
        List<ItemImageResponse> response = itemImageService.uploadItemImages(itemId, authentication.getName(), images,
                representativeIndex);
